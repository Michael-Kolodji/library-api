...
class BookControllerTest {
	...
	@Test
	@DisplayName("Deve lançar erro ao tentar cadastrar um livro com isbn utilizado por outro")
	...
	@Test
	@DisplayName("Deve retornar recurso não encontrado quando o livro procurado não existir")
	...
	@Test
	@DisplayName("Deve retornar recurso não encontrado quando não encontrar o livro para excluir")
	...
	void findBook() throws Exception {
		...
		Book book = Book.builder().id(id).title(createNewBookDTO().getTitle()).author(createNewBookDTO().getAuthor()).isbn(createNewBookDTO().getIsbn()).build();
